...
class DynamicFormWidget extends \yii\base\Widget {
     ...
     * @var string
     */
    public $autocompleteDatasourcechild;

    /**
     * @var string
     */
    public $uniqueClasschild;
    ...
    protected function initOptions() {
        ...
        $this->_options['autocompleteDatasource'] = $this->autocompleteDatasource;
        $this->_options['uniqueClass'] = $this->uniqueClass;
        $this->_options['autocompleteDatasourcechild'] = $this->autocompleteDatasourcechild;
        $this->_options['uniqueClasschild'] = $this->uniqueClasschild;
    ...
    public function registerAssets() {
        ...
        if (!empty($this->uniqueClass) && !empty($this->autocompleteDatasource)) {
            $js.='jQuery(".' . $this->uniqueClass . '").autocomplete({';
            $js.='source:' . json_encode($this->autocompleteDatasource);
            $js.='});';
        }

        if (!empty($this->uniqueClasschild) && !empty($this->autocompleteDatasourcechild)) {
            $js.='jQuery(".' . $this->uniqueClasschild . '").autocomplete({';
            $js.='source:' . json_encode($this->autocompleteDatasourcechild);
